...
PLATFORM_HINT = (
    ...
    "short cue the user could say or ask right now (imperative, ready to "
    "speak, not a fact to translate), 12 words max, and only respond when "
    "you have something genuinely useful to say. Replies tagged with "
    "chat_id ending ':chat' are direct user messages, answer them "
    "conversationally."
)
